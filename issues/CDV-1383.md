...
http://svn.terracotta.org/svn/forge/projects/tim-tomcat/trunk/tim-tomcat-5.5/src/main/java/org/terracotta/modules/tomcat/tomcat\15\15/SessionValve55.java
...
\1 change mgrs back to be a HashMap, but non-final.
\1 add private final Object mgrsUpdateSemaphore = new Object();
\1 adjust findOrCreateManager to be:
...
org.terracotta.modules.tomcat.tomcat\15\15.SessionValve55.tcInvoke(SessionValve55.java:59)
org.terracotta.modules.tomcat.tomcat\15\15.SessionValve55.invoke(SessionValve55.java:50)
...
I guess that the correct solution then is to take a similar approach (to Tomcat) and pool the org.apache.catalina.connector.SessionRequest55 request objects - ie. create a pool in the org.terracotta.modules.tomcat.tomcat\15\15.SessionValve55 class, and recycle them back to the pool after each request is completed.
