...
Are you talking about "receive\1transaction\1thread" or the DMI thread ?

receive\1transaction\1thread is single threaded to ensure transaction sequence (at least for now)
