 ...
 * @version $Id: Server.java 1968 2010-03-04 16:48:54Z gluck $
 */
public class Server implements Daemon {
     ...
     */
    static void stopStatic() throws InterruptedException, LifecycleException , GlassFishException{
     ...
     */
    public void stop() throws InterruptedException, LifecycleException, GlassFishException {
...
//        String[] arguments = {"9090", "target/war/work/net.sf.ehcache/ehcache-server/greg.war"};
    ...
    abstract class ServerThread extends Thread {
         ...
         * Stops the server.
         */
        public abstract void stopServer() throws LifecycleException, GlassFishException;
    }
    ...
    class GlassfishServerThread extends ServerThread {
        ...
        private void startWithGlassfish() {
            ...
            try {
                ...
                deployer.deploy(war, "--contextroot=ehcache", "--enabled=true" ,"--force=true");//params);
         ...
         * Stops the server
         */
        public void stopServer() throws LifecycleException , GlassFishException{
