...
public class DirtyObjectDbCleaner {
  ...
  protected void backupDirtyObjectDb() throws TCDatabaseException {
    ...
    trimDirtyObjectDbBackups(dirtyDbBackupPath.getFile());
  }
  
  protected void trimDirtyObjectDbBackups(File dirtyDbBackupPath) {
	 int nofBackups = TCPropertiesImpl.getProperties()
  	   .getInt(TCPropertiesConsts.L2_NHA_DIRTYDB_ROLLING, 0);
	 if (nofBackups <= 0) {
		return; // nothing to do, there is no rolling of old backups
	 }
